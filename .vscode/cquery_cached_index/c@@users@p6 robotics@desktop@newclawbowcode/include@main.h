...
#define SHOULDER_LIMIT_SWITCH 4
#define SHOULDER_ENCODER_TOP_PORT 9
#define SHOULDER_ENCODER_LOWER_PORT 8
#define ELBOW_ENCODER_TOP_PORT 7
#define ELBOW_ENCODER_LOWER_PORT 6
